...
import * as TestnetProtocols from './testnet-protocol.json'; // go to testnet node w/ user cardano (cardano-multinet-1 or submit-api-testnet):  cardano-cli query protocol-parameters --testnet-magic 1097911063 or cardano-cli query protocol-parameters --testnet-magic 1 (preprod). export CARDANO_NODE_SOCKET_PATH= cnode/preprod/sockets/node.socket 
