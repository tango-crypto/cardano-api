...
import * as TestnetProtocols from './testnet-protocol.json'; // go to testnet node (cardano-submit-testnet):  cardano-cli query protocol-parameters --testnet-magic 1097911063
