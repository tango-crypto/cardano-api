import { fromValue, ignore, mapDefer, mapFrom, mapWith, SnakeCaseNamingConvention } from '@automapper/core';
...
export class TransactionProfile extends AutomapperProfile {
  ...
  mapProfile() {
    return (mapper: Mapper) => {
      ...
      .forMember(dest => dest.block, mapDefer<Transaction>(src => src.block ? fromValue(mapper.map<Block, BlockDto>(src.block, 'BlockDto', 'Block')) : ignore()))
